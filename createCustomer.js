...
request(`http://apis.fretron.com/shipment-view/places/page/places?size=1000`, {
  ...
  //   cc("VMart Warehouse",{
	// 	"hubId": null,
	// 	"boundary": null,
	// 	"address": "Taura Road, Near GITM Women's College, Gurugram Dist., Bilaspur Kalan, Haryana 122105, India",
	...
	// 	"suggestedRadius": 307,
	// 	"isOwned": false,
	// 	"centerCoordinates": [76.87409520000001, 28.2843802],
...
function customerPlace() {
  customers.forEach((c, index) => {
      let place=places.find(item => item.name == placesName[index])
    if (place) {
      cc(c,place)
    }
  });
...
function cc(cu,pl) {
    let customer={
        "address": "{\"address\":\""+pl.address+"\",\"city\":null,\"state\":null,\"pincode\":null}",
        "contacts": [],
        "customFields": [],
        "externalId": null,
        "fretronId": null,
    ...
    var options = {
        method: "POST",
        uri: "http://apis.fretron.com/business-partners/v1/partner",
        body: customer,
        json: true,
        headers: {
          "Content-Type": "application/json",
